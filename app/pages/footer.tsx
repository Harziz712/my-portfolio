...
export default function Footer() {
  return (
    // <footer ">
    <Glassmorphism className="w-full h-[30vh] py-8 px-6 md:px-16 lg:px-24 flex flex-col md:flex-row justify-between items-end">
      {/* Left Section */}
      ...
      {/* Center Section */}
      <div className="text-center text-gray-500 text-sm mt-4 md:mt-0">
      ...
      <div className="flex flex-col items-center md:items-end gap-4 mt-4 md:mt-0">
        ...
        <Link
                href="https://wa.me/+2347087875399">   <p className="text-primary  flex items-center gap-2 text-sm">
